module.exports = class {
  ...
  async create(data) {
    this.method.check.assert(this.method.check.object(data), "expected object as first argument");
    const template = { owner_id: "string", body: "string", categories: "string", public: "boolean" };
    this.method.utils.checktypes({ template: template, params: data });
  }
  ...
  async update(data) {
    this.method.check.assert(this.method.check.object(data), "expected object as first argument");
    const template = { _id: "string", owner_id: "string", body: "string", categories: "string", public: "boolean" };
    this.method.utils.checktypes({ template: template, params: data });
  }
